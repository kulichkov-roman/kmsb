...
<?if($arResult["ITEMS"]){?>
								...
								<?if($arItem["DETAIL_TEXT"] <> ""){?>
									<div class="catalog-item__descr">
										<?if(mb_strlen($arItem["DETAIL_TEXT"]) > LENGTH_PREVIEW_TEXT){?>
											...
											<?=truncateStr($arItem["DETAIL_TEXT"], LENGTH_PREVIEW_TEXT, $endStr, 'html');?>
										<?}?>
									</div>
								<?}?>
							</div>
	...
	<div class="catalog-legend__header">
		Условные обозначения:</div>
		<div class="catalog-legend__content">
			<div class="catalog-label">
				...
				<div class="catalog-label__item">
					<span class="catalog-label__icon catalog-label__icon_action" title="Специальное предложение. Акция!">&nbsp;</span> <span class="catalog-label__text">Специальное предложение. Акция!</span>
				</div>
			</div>
		</div>
	</div>
