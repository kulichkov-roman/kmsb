    ...
    <form action="<?=$APPLICATION->GetCurPage()?>" method="get">
        <table border="0" cellpadding="0" cellspacing="0" class="compare-grid">
                        ...
                        <td>
                            <div class="compare__item">
                                ...
                                <div class="compare__item__img">
                                  	<div class="compare__item__img__wrap">
                                  	  	<a href="<?=$arElement["DETAIL_PAGE_URL"]?>">
                                  	  		<img src="<?=$photo?>" />
                                  	  	</a>
										<?if($arElement["PROPERTIES"]["AVAILABLE_ICO"]["VALUE_XML_ID"] == 'Y' || $arElement["CATALOG_QUANTITY"] > 0){?>
                                ...
                                <a class="compare__item__title" href="<?=$arElement["DETAIL_PAGE_URL"]?>"><?=$arElement["PROPERTIES"]["NAIMENOVANIE_DLYA_SAYTA_KRATKOE"]["VALUE"] <> "" ? $arElement["PROPERTIES"]["NAIMENOVANIE_DLYA_SAYTA_KRATKOE"]["VALUE"] : $arElement["NAME"]?></a>
            ...
            <tbody>
                            ...
                            foreach($arResult["ITEMS"] as $arElement)
                            {
                                if($diff) 
                                {
                                    ...
                                    <td>
                                        ...
                                        {
											echo htmlspecialcharsBack(implode("/ ", $arElement["DISPLAY_PROPERTIES"][$code]["DISPLAY_VALUE"]));
                                        } 
                                        else
                                        {
                                            if($arElement["DISPLAY_PROPERTIES"][$code]["DISPLAY_VALUE"] <> "")
                                            {
                                                echo htmlspecialcharsBack($arElement["DISPLAY_PROPERTIES"][$code]["DISPLAY_VALUE"]);
                                            }
                                            else
                                            {
                                                echo "—";
				...
				<tr class="compare-grid__row_labels">
					<td>&nbsp;</td>
					<?
					foreach($arResult["ITEMS"] as $arElement) {
					?>
