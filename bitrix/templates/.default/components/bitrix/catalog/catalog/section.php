...
if ($arParams['USE_FILTER'] == 'Y')
{
    ...
    $APPLICATION->ShowViewContent("showCatSectionName");
    $APPLICATION->ShowViewContent("showCatSectionDescriptionTop");
    //if($USER->isAdmin()){
...
$APPLICATION->ShowViewContent("showCatSectionUFDescriptionBottom");
