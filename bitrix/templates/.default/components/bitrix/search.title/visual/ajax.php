		...
		<?elseif(isset($arResult["ELEMENTS"][$arItem["ITEM_ID"]])):
			...
			<div class="bx_item_block">
				...
				<div class="bx_item_element">
                    ...
                    <a href="<?echo $arItem["URL"]?>"><?echo $arElement["PROPERTY_NAIMENOVANIE_DLYA_SAYTA_POLNOE_VALUE"]?> <?if($arElement["PROPERTY_CML2_ARTICLE_VALUE"] <> ""){?><br/>(артикул <?echo $arElement["PROPERTY_CML2_ARTICLE_VALUE"]?>)<?}?></a>
					<?
