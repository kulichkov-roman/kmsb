...
<div class="b-specials">
    ...
    <div class="b-offers">
        <ul class="goods__list goods__list_offers">
            <li class="goods__item">
                <div class="goods__img">
                    <div class="goods__img-wrap"><a href="javascript:;" class="goods__link"><img src="/files/kom-sib/Image/spec1.jpg"></a></div>
                </div>
                <div class="goods__text">
                    <a href="javascript:;" class="goods__link">Мебель лабораторная серии «Практика»</a>
                    <div class="goods__price">Цена 10 000 руб.</div>
                    <a class="more-link" href="/special-offers/8247637/">Подробнее...</a>
                </div>
            </li>
            <li class="goods__item">
                <div class="goods__img">
                    <div class="goods__img-wrap"><a href="javascript:;" class="goods__link"><img src="/files/kom-sib/Image/spec2.jpg"></a></div>
                </div>
                <div class="goods__text">
                    <a href="javascript:;" class="goods__link">Система разбавления автоматическая AutoPrep 50</a>
                    <div class="goods__price">Цена 10 000 руб.</div>
                    <a class="more-link" href="/special-offers/8247830/">Подробнее...</a>
                </div>
            </li>
            <li class="goods__item">
                <div class="goods__img">
                    <div class="goods__img-wrap"><a href="javascript:;" class="goods__link"><img src="/files/kom-sib/Image/spec3.jpg"></a></div>
                </div>
                <div class="goods__text">
                    <a href="javascript:;" class="goods__link">Анализатор влажности Mettler Toledo HG63</a>
                    <div class="goods__price">Цена 10 000 руб.</div>
                    <a class="more-link" href="/special-offers/8247831/">Подробнее...</a>
                </div>
            </li>
            <li class="goods__item">
                <div class="goods__img">
