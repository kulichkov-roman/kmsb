...
<ul class="goods__list goods__list_avail">
	<li class="goods__item">
		<div class="goods__img"><a href="javascript:;" class="goods__link"><img src="/images/avail1.jpg"></a></div>
		<a href="javascript:;" class="goods__link">Весы лабораторные аналитические XP</a>
	</li>
	<li class="goods__item">
		<div class="goods__img"><a href="javascript:;" class="goods__link"><img src="/images/avail2.jpg"></a></div>
		<a href="javascript:;" class="goods__link">Бани со встроенным шейкером DAIHAN WiseBath WSB</a>
	</li>
	<li class="goods__item">
		<div class="goods__img"><a href="javascript:;" class="goods__link"><img src="/images/avail3.jpg"></a></div>
		<a href="javascript:;" class="goods__link">Мельница планетарная Pulverisette 5</a>
	</li>
</ul>
