...
if (!empty($arResult['ITEMS']))
{
	...
	$arResult["SHOW_SYMBOLS"]["SHOW_SYMBOLS_FLAG"] = "N";
	
	foreach($arResult["ITEMS"] as $id=>$arItem)
	{
		if($arResult["SHOW_SYMBOLS"]["SHOW_SYMBOLS_FLAG"] == "N")
		{
			if($arItem["PROPERTIES"]["SHOW_ICO"]["VALUE"] == 'Y')
			{
				$arResult["SHOW_SYMBOLS"]["SHOW_SYMBOLS_FLAG"] = "Y";
			}
		}
		...
		{
			if($arItem["PROPERTIES"]["AVAILABLE_ICO"]["VALUE_XML_ID"] == 'Y')
			{
