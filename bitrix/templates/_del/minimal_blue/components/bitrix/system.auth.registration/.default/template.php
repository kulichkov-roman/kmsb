...
$APPLICATION->IncludeComponent(
	...
	Array(
		"USER_PROPERTY_NAME" => "",
		"SEF_MODE" => "N",
		"SHOW_FIELDS" => array("PERSONAL_PROFESSION", "NAME", "LAST_NAME", "SECOND_NAME", "WORK_COMPANY", "WORK_COUNTRY", "WORK_CITY", "WORK_STREET", "WORK_NOTES", "WORK_PHONE"),
		"REQUIRED_FIELDS" => array("NAME", "LAST_NAME", "SECOND_NAME", "WORK_COMPANY", "WORK_COUNTRY", "WORK_CITY", "WORK_STREET", "WORK_NOTES", "WORK_PHONE"),
		"AUTH" => "N",
		"USE_BACKURL" => "N",
		"SUCCESS_PAGE" => "/login/ok.php",
		"SET_TITLE" => "Y",
		"USER_PROPERTY" => array("UF_FILES")
	),
false
);
?>
