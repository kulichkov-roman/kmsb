...
$MESS["SOA_TEMPL_PROP_CHOOSE_DESCR"] = "вы можете выбрать информацию, которую указывали раннее при оформлении заказа";
$MESS["SOA_TEMPL_PROP_PROFILE"] = "Ваш профиль:";
...
$MESS["SOA_TEMPL_PAY_ACCOUNT_TEXT"] = "На вашем пользовательском счете есть <b>#MONEY#</b>, которые вы можете использовать для полного или частичного погашения суммы заказа.";
...
$MESS["SOA_TEMPL_SUM_ADIT_INFO"] = "Ваши комментарии к заказу";
