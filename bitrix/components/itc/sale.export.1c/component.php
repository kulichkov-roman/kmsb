...
else
{
	...
	elseif($_GET["mode"] == "file")
	{
     ...
     //!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
     $dbStatus = CSaleStatus::GetList(Array("SORT" => "ASC"), Array("LID" => LANGUAGE_ID));
     $statusNameToCode = array();

     while($arStatus = $dbStatus->Fetch())
     {
      $statusNameToCode["[".$arStatus['ID']."] ".$arStatus['NAME']] = $arStatus['ID'];
     }
     //!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
*/
       ...
       //!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
       if(!empty($statusNameToCode[$v['TRAITS']['Статус заказа']]) && $orderInfo['STATUS_ID'] != $statusNameToCode[$v['TRAITS']['Статус заказа']])
       {
        CSaleOrder::StatusOrder($orderInfo['ID'], $statusNameToCode[$v['TRAITS']['Статус заказа']]);
       }
       //!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
						}
						else
